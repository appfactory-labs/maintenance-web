...
export default function SupportPage() {
  return (
    <div className="site-shell">
      <SiteHeader />
      <main className="shell support-main">
        <div className="support-layout">
          <section className="support-hero fade-up">
            <p className="effective-date">Support</p>
            <h1 className="legal-title">We are here to help.</h1>
            <p className="legal-intro">
              Send a note about vehicle records, reminders, service history, billing questions,
              or anything that is not working as expected.
            </p>
